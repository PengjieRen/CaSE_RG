...
def train(args):
    ...
    train_dataset = CaSEDataset(train_samples, None, None, None, None, None, None, None, None, None, None, sample_tensor=torch.load(data_path + '.CaSE.dataset.pkl'))

    model = CaSE(max_span_size, max_target_length, id2vocab, vocab2id, hidden_size)
    init_params(model)
...
def test(args):
    ...
    marco_dev_dataset = CaSEDataset(marco_dev_samples, None, None, None, None, None, None, None, None, None, None, sample_tensor=torch.load(data_path + 'marco/marco.dev.CaSE.dataset.pkl'))

    marco_test_samples = torch.load(data_path + 'marco/marco.test.pkl')
    marco_test_dataset = CaSEDataset(marco_test_samples, None, None, None, None, None, None, None, None, None, None, sample_tensor=torch.load(data_path + 'marco/marco.test.CaSE.dataset.pkl'))

    cast_test_samples = torch.load(data_path + '.pkl')
    cast_test_dataset = CaSEDataset(cast_test_samples, None, None, None, None, None, None, None, None, None, None, sample_tensor=torch.load(data_path + '.CaSE.dataset.pkl'))
