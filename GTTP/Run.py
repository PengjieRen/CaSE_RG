...
def train(args):
    ...
    train_dataset = GTTPDataset(train_samples, None, None, None, None, None, None, None, sample_tensor=torch.load(os.path.join(data_path,  args.dataset+ '.train.GTTP.dataset.pkl')))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--output_path", type=str, default='./output/GTTP/')
